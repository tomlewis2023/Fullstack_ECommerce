...
const VerticalCard = ({loading,data=[]}) => {
  ...
  return (
    <div className="grid grid-cols-[repeat(auto-fit,minmax(300px,300px))] justtify-center md:justify-between md:gap-4 overflow-x-scroll scrollbar-none transition-all">
        {loading
          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  key={index}
                  className="w-full min-w-[290px] md:min-w-[300px] max-w-[290px] md:max-w-[310px] bg-white rounded-sm shadow"
                >
