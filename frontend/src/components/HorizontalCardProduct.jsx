...
const HorizontalCardProduct = ({ category, heading }) => {
  ...
  const loadingList = new Array(13).fill(null); //skeliton effect
  ...
  //call categorywise function from helper folder
      ...
      >
        ...
        {loading
          ? loadingList.map((product, index) => {
              return (
                <div className="w-full min-w-[290px] md:min-w-[320px] max-w-[290px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex" key={index}>
          ...
          : data.map((product, index) => {
              return (
                <Link
                  ...
                  className="w-full min-w-[290px] md:min-w-[320px] max-w-[290px] md:max-w-[320px] h-36 bg-white rounded-sm shadow flex"
                  key={index}
                >
